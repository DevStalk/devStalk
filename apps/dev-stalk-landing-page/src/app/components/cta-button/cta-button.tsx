...
export function CtaButton(props: CtaButtonProps) {
  ...
  const ForDesktopOrLaptop = () => {
    ...
    return (
      ...
      <div className={`${styles.cta} ${styles.cta_d} ${styles.cta_d__trans}`}>
        <input
          className={`${styles.cta_d__input} ${styles.cta_d__input__clicked} `}
          placeholder="iwant@developeridentity.com"
          onChange={(e) => setInput(e.target.value)}
        ></input>
        <a className={styles.cta__button}>Join Waitlist</a>
      </div>
    );
  };
